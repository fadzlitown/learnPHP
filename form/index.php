...
//get the the action value (select,delate ,add)
...
//select all data
//$query valid SQL statement for the target database
$query = "SELECT id, firstname, lastname, username FROM users";

//prepare() a statement for execution and returns a $query object
...
<script type='text/javascript'>
    //func for onClick delete button
